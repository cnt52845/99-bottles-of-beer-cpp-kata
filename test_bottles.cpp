...
public:
    ...
    void test_last_verse()
    {
        const int         verse             = max_verse;
        const int         first_line_index  = verse * 2;
        const int         second_line_index = verse * 2 + 1;
        const int         min_song_size     = verse * 2 + 2;
        const std::string expected_1st_line =
            "No more bottles of beer on the wall, no more bottles of "
            "beer.";
        const std::string expected_2nd_line = "Go to the store and buy some more, " +
                                              std::to_string(max_verse) +
                                              " bottles of beer on "
                                              "the wall.";
